...
#define OW_FLAG_NO_ENCOUNTER        1  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      2  // If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        3  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
